...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" data-parsley-validate action="">
		...
		<?php } if ($usp_options['usp_phone'] == 'show' || $usp_options['usp_phone'] == 'optn') { ?>
		
		<fieldset class="usp-phone">
			<label for="user-submitted-phone"><?php esc_html_e('Your Phone', 'usp'); ?></label>
			<input id="user-submitted-phone" name="user-submitted-phone" type="text" value="" placeholder="<?php esc_attr_e('Your Phone', 'usp'); ?>"<?php if (usp_check_required('usp_phone')) echo $usp_required; ?> class="usp-input">
		</fieldset>
