...
function usp_auto_display_phone($content) {
	
	global $usp_options;
	
	$location = isset($usp_options['auto_display_phone']) ? $usp_options['auto_display_phone'] : '';
	$markup   = isset($usp_options['auto_phone_markup'])  ? $usp_options['auto_phone_markup'] : '';
	$phone = apply_filters('usp_phone_custom_field', get_post_meta(get_the_ID(), 'user_submit_phone', true));
	$title = get_the_title(get_the_ID());
	if (!empty($phone)) {
...
add_filter('the_content', 'usp_auto_display_phone');
